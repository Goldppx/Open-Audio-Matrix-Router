...
`FanoutSettings`, `MatrixSettings`, `SenderSettings`, `ReceiverSettings`,
`NetworkMixerSettings`) and
...
2. Add per-input gain, mute, channel maps, and feedback-loop safety policy.
